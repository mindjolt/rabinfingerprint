...
import com.jamcity.rabinfingerprint.datastructures.Interval;
import com.jamcity.rabinfingerprint.handprint.FingerFactory.ChunkVisitor;
...
public class Handprint {
	...
	public Long getPalm() {
		...
		try {
			...
			throw new Handprints.HandprintException("Error while computing fingerprints", e);
		}
		return palm;
	}
